...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/avalon_timer_32b_qsys_tb/simulation/submodules/avalon_timer_32b_qsys_irq_mapper.sv"       -work irq_mapper                                                         -cdslib ./cds_libs/irq_mapper.cds.lib                                                        
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/avalon_timer_32b_qsys_tb/simulation/submodules/avalon_timer_32b_qsys.v"                   -work avalon_timer_32b_qsys_inst                                         -cdslib ./cds_libs/avalon_timer_32b_qsys_inst.cds.lib                                        
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/avalon_timer_32b_qsys_tb/simulation/avalon_timer_32b_qsys_tb.v"                                                                                                                                                                                                 
fi
